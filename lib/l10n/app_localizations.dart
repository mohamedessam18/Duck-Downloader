...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'folderDeleteBody': 'The files inside go back to your library. Nothing is deleted.',
      'folderMoveTo': 'Move to folder',
      'folderNone': 'No folder',
      'folderNameInvalid': 'Give the folder a name.',
      'folderNameTaken': 'That name is already taken.',
      'folderVaultRefused': 'Vault files stay in the vault.',
      'folderMoveFailed': 'Could not move that file.',
      'folderEmpty': 'No folders yet',
      'folderEmptyBody': 'Make one, then move files into it.',
      'folderAll': 'All files',
      'myFolders': 'My folders',
      'deviceFolders': 'On this phone',
      'storageTitle': 'Storage',
      'storageTotal': 'held by Duck',
      'storageLargest': 'Biggest files',
      'storageInTrash': '{size} of that is {count} deleted files waiting to be erased.',
      'settingsStorage': 'Storage',
      'settingsStorageBody': 'See what is taking up room, and free some.',
      ...
      'trashDeleteNow': 'Delete now',
      'trashEmptyAll': 'Empty trash',
      'trashRestored': 'Restored',
      'trashRestoreFailed': 'Could not put that file back.',
      'trashDaysLeft': '{days} days left',
      'trashOneDayLeft': 'Last day',
      'settingsTrash': 'Recently deleted',
      'settingsTrashBody': 'Files you deleted in the last 7 days.',
      'librarySearchHint': 'Search your files',
      'sortBy': 'Sort',
      ...
      'searchNoResultsBody': 'Try a shorter word, or check another tab.',
    ...
    'ar': {
      ...
      'folderRename': 'غيّر اسم المجلد',
      'folderDelete': 'امسح المجلد',
      'folderDeleteBody': 'الملفات اللي جوّه بترجع لمكتبتك. مفيش حاجة بتتمسح.',
      'folderMoveTo': 'انقل لمجلد',
      'folderNone': 'من غير مجلد',
      'folderNameInvalid': 'اكتب اسم للمجلد.',
      'folderNameTaken': 'الاسم ده مستخدم خلاص.',
      'folderVaultRefused': 'ملفات الخزنة بتفضل في الخزنة.',
      'folderMoveFailed': 'مقدرناش ننقل الملف ده.',
      'folderEmpty': 'مفيش مجلدات لسه',
      'folderEmptyBody': 'اعمل واحد، وبعدين انقل فيه ملفات.',
      'folderAll': 'كل الملفات',
      'myFolders': 'مجلداتي',
      'deviceFolders': 'على الموبايل',
      'storageTitle': 'المساحة',
      'storageTotal': 'محجوزة بواسطة Duck',
      'storageLargest': 'أكبر الملفات',
      'storageInTrash': 'منهم {size} في {count} ملف محذوف مستني المسح.',
      'settingsStorage': 'المساحة',
      'settingsStorageBody': 'شوف إيه اللي واخد مكان، وفضّي شوية.',
      ...
      'trashDeleteNow': 'امسح دلوقتي',
      'trashEmptyAll': 'فضّي المحذوفات',
      'trashRestored': 'اترجّع',
      'trashRestoreFailed': 'مقدرناش نرجّع الملف ده.',
      'trashDaysLeft': 'فاضل {days} يوم',
      'trashOneDayLeft': 'آخر يوم',
      'settingsTrash': 'المحذوفات',
      'settingsTrashBody': 'الملفات اللي مسحتها في آخر ٧ أيام.',
      'librarySearchHint': 'دوّر في ملفاتك',
      'sortBy': 'ترتيب',
      'sortNewest': 'الأحدث أولاً',
      'sortOldest': 'الأقدم أولاً',
      'sortLargest': 'الأكبر أولاً',
      'sortSmallest': 'الأصغر أولاً',
      'sortName': 'الاسم',
      'searchNoResults': 'مفيش حاجة بالاسم ده',
      'searchNoResultsBody': 'جرّب كلمة أقصر، أو شوف تبويب تاني.',
